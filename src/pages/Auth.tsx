  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        ...
        >
          ...
          <div className="flex items-center gap-3 mb-8">
            <div className="w-12 h-12 rounded-xl bg-gradient-sunset flex items-center justify-center shadow-lg">
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                {isLogin ? 'Sign in to plan your adventure' : 'Start planning your adventures'}
              </p>
            </div>
          </div>
      ...
      <div className="hidden lg:flex flex-1 bg-gradient-hero items-center justify-center p-8 relative overflow-hidden">
        ...
        >
          <div className="w-20 h-20 rounded-2xl bg-white/20 backdrop-blur-lg flex items-center justify-center mx-auto mb-8 animate-float">
          ...
          <p className="text-white/80 text-lg">
            Join 10,000+ students who are exploring the world on a budget with AI-powered travel planning.
          </p>
